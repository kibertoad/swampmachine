package net.kiberion.swampmachine.blueprints.common.processors.random.impl;

import java.util.Random;

import net.kiberion.swampmachine.blueprints.common.processors.random.api.RandomProvider;
